<?php
// source: /data/web/virtuals/88857/virtual/app/FrontModule/DefaultModule/templates/Organization/ranger.latte

// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('4768055262', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block submenu
//
if (!function_exists($_b->blocks['submenu'][] = '_lbba4d61abbb_submenu')) { function _lbba4d61abbb_submenu($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb21f9890b14_content')) { function _lb21f9890b14_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
<?php $_b->templates['4768055262']->renderChildTemplate('member.latte', array('showAge' => TRUE) + $template->getParameters()) ;
}}
