<?php
// source: /data/web/virtuals/88857/virtual/app/FrontModule/DefaultModule/templates/Homepage/lounge.latte

// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('9666065767', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block head
//
if (!function_exists($_b->blocks['head'][] = '_lbae6873ba08_head')) { function _lbae6873ba08_head($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block submenu
//
if (!function_exists($_b->blocks['submenu'][] = '_lbea216f41c5_submenu')) { function _lbea216f41c5_submenu($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lbda9003062a_content')) { function _lbda9003062a_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lb22e47e5b2d_scripts')) { function _lb22e47e5b2d_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
