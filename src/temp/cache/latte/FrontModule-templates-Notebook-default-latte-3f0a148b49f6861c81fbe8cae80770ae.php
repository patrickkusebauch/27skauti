...
list($_b, $_g, $_l) = $template->initialize('6502952236', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block head
//
if (!function_exists($_b->blocks['head'][] = '_lbc9cca37e76_head')) { function _lbc9cca37e76_head($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb50d4eaabec_content')) { function _lb50d4eaabec_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
