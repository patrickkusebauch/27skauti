...
list($_b, $_g, $_l) = $template->initialize('5773124302', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block head
//
if (!function_exists($_b->blocks['head'][] = '_lbd81dfaad45_head')) { function _lbd81dfaad45_head($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
;
}}
...
// block submenu
//
if (!function_exists($_b->blocks['submenu'][] = '_lb2c6fc42270_submenu')) { function _lb2c6fc42270_submenu($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
;
}}
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lb8b7bedfd44_scripts')) { function _lb8b7bedfd44_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
;
}}
