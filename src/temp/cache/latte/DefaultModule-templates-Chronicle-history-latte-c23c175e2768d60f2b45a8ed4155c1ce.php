<?php
// source: /vagrant/src/app/FrontModule/DefaultModule/templates/Chronicle/history.latte

// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('1381442649', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block submenu
//
if (!function_exists($_b->blocks['submenu'][] = '_lbe661fd740c_submenu')) { function _lbe661fd740c_submenu($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb2be877921b_content')) { function _lb2be877921b_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
