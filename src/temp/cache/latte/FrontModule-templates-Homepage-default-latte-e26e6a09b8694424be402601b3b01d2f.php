...
list($_b, $_g, $_l) = $template->initialize('3916418016', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block head
//
if (!function_exists($_b->blocks['head'][] = '_lba4eaa10ed4_head')) { function _lba4eaa10ed4_head($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb944f3756fb_content')) { function _lb944f3756fb_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
