<?php
// source: /vagrant/src/app/FrontModule/DefaultModule/templates/Homepage/parent.latte

// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('3019346141', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block head
//
if (!function_exists($_b->blocks['head'][] = '_lb6c06d05005_head')) { function _lb6c06d05005_head($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block submenu
//
if (!function_exists($_b->blocks['submenu'][] = '_lb9f5ebfea2b_submenu')) { function _lb9f5ebfea2b_submenu($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb495417c58c_content')) { function _lb495417c58c_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
