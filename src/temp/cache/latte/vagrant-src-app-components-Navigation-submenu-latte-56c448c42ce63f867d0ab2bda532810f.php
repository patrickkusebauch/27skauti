<?php
// source: /vagrant/src/app/components/Navigation/submenu.latte

// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('6300183752', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block menu
//
if (!function_exists($_b->blocks['menu'][] = '_lb232a78a154_menu')) { function _lb232a78a154_menu($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><ul>
