<?php
// source: /vagrant/src/app/FrontModule/DefaultModule/templates/Homepage/contact.latte

// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('0211573723', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block submenu
//
if (!function_exists($_b->blocks['submenu'][] = '_lb24aca33bd1_submenu')) { function _lb24aca33bd1_submenu($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lbf61675f44c_content')) { function _lbf61675f44c_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
<?php $_b->templates['0211573723']->renderChildTemplate('../common/member_picture.latte', array('member' => $leader) + $template->getParameters()) ?>
		</div>
