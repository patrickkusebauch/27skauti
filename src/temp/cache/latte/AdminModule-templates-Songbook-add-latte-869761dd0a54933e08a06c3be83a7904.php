<?php
// source: /data/web/virtuals/88857/virtual/app/modules/OddilModule/AdminModule/templates/Songbook/add.latte

// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('9207231099', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb3ade078a6d_content')) { function _lb3ade078a6d_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lbee244ec057_scripts')) { function _lbee244ec057_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
