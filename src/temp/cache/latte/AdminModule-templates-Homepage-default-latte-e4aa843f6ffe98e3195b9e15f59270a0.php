<?php
// source: /data/web/virtuals/88857/virtual/app/OddilModule/AdminModule/templates/Homepage/default.latte

// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('5288888807', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lba429cf13be_content')) { function _lba429cf13be_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
