<?php
// source: /data/web/virtuals/88857/virtual/app/FrontModule/DefaultModule/templates/@layout.latte

// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('8009111061', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block head
//
if (!function_exists($_b->blocks['head'][] = '_lb662a2d48b0_head')) { function _lb662a2d48b0_head($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
;
}}
...
// block submenu
//
if (!function_exists($_b->blocks['submenu'][] = '_lbc324f964ee_submenu')) { function _lbc324f964ee_submenu($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
;
}}
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lb0a869d8fe2_scripts')) { function _lb0a869d8fe2_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
;
}}
