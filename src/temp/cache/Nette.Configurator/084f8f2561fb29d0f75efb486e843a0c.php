...
// source: /vagrant/src/app/config/config-local.neon 
...
class SystemContainer extends Nette\DI\Container
{
	...
	{
		$service = new Nette\Database\Connection('mysql:host=127.0.0.1;dbname=27skauti', 'root', 'root', NULL);
	...
	{
		$service = SkautIS\SkautIS::getInstance('cb32ee0e-543d-4998-8723-0dda08da4920', TRUE, TRUE);
