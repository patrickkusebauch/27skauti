...
list($_b, $_g, $_l) = $template->initialize('0940623588', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block head
//
if (!function_exists($_b->blocks['head'][] = '_lbd46da28f02_head')) { function _lbd46da28f02_head($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb37ad32078e_content')) { function _lb37ad32078e_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lb9c4a4c4400_scripts')) { function _lb9c4a4c4400_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
