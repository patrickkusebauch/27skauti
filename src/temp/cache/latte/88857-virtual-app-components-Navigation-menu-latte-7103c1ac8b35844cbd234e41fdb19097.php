<?php
// source: /data/web/virtuals/88857/virtual/app/components/Navigation/menu.latte

// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('8949258841', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block menu
//
if (!function_exists($_b->blocks['menu'][] = '_lb0cc9a8e392_menu')) { function _lb0cc9a8e392_menu($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><ul>
