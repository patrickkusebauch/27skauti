<?php
// source: /data/web/virtuals/88857/virtual/app/OddilModule/FrontModule/templates/Songbook/default.latte

// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('2998309068', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block head
//
if (!function_exists($_b->blocks['head'][] = '_lb04d1028cbf_head')) { function _lb04d1028cbf_head($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb4994ca6d38_content')) { function _lb4994ca6d38_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
