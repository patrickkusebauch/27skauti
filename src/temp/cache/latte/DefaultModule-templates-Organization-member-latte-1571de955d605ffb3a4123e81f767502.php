<?php
// source: /vagrant/src/app/FrontModule/DefaultModule/templates/Organization/member.latte

// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('2430584212', 'html')
;
...
<?php $_b->templates['2430584212']->renderChildTemplate('../common/member_picture.latte', array('member' => $member) + $template->getParameters()) ?>
		</div>
