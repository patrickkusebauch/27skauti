...
list($_b, $_g, $_l) = $template->initialize('0922141072', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block head
//
if (!function_exists($_b->blocks['head'][] = '_lb1f4277c053_head')) { function _lb1f4277c053_head($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb63d4a7ea1a_content')) { function _lb63d4a7ea1a_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
