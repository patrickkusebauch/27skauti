<?php
// source: /data/web/virtuals/88857/virtual/app/modules/OddilModule/FrontModule/templates/@layout.latte

// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('2443454462', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block head
//
if (!function_exists($_b->blocks['head'][] = '_lb59bc8dc553_head')) { function _lb59bc8dc553_head($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
;
}}
...
// block submenu
//
if (!function_exists($_b->blocks['submenu'][] = '_lb6b1dcbce9a_submenu')) { function _lb6b1dcbce9a_submenu($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
;
}}
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lb3792b3a9a5_scripts')) { function _lb3792b3a9a5_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
;
}}
