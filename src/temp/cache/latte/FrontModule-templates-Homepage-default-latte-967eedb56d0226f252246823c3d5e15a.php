<?php
// source: /data/web/virtuals/88857/virtual/app/OddilModule/FrontModule/templates/Homepage/default.latte

// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('5560055019', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block head
//
if (!function_exists($_b->blocks['head'][] = '_lbc9732f4c46_head')) { function _lbc9732f4c46_head($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb12553b40a0_content')) { function _lb12553b40a0_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
