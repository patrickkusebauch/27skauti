<?php
// source: /vagrant/src/app/FrontModule/DefaultModule/templates/Organization/oldscout.latte

// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('3631302561', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block submenu
//
if (!function_exists($_b->blocks['submenu'][] = '_lb7f3bbe29d1_submenu')) { function _lb7f3bbe29d1_submenu($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb493a9f0afa_content')) { function _lb493a9f0afa_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
<?php $_b->templates['3631302561']->renderChildTemplate('member.latte', array('showAge' => TRUE) + $template->getParameters()) ;
}}
