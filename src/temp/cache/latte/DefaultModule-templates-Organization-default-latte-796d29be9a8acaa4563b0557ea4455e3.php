<?php
// source: /vagrant/src/app/FrontModule/DefaultModule/templates/Organization/default.latte

// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('9668948769', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block submenu
//
if (!function_exists($_b->blocks['submenu'][] = '_lb2d2990adbf_submenu')) { function _lb2d2990adbf_submenu($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb0f8259ae13_content')) { function _lb0f8259ae13_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
