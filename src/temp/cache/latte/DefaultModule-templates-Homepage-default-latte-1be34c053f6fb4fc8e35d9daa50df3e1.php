<?php
// source: /data/web/virtuals/88857/virtual/app/FrontModule/DefaultModule/templates/Homepage/default.latte

// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('8217734513', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block head
//
if (!function_exists($_b->blocks['head'][] = '_lbb7af2b10d1_head')) { function _lbb7af2b10d1_head($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block submenu
//
if (!function_exists($_b->blocks['submenu'][] = '_lb7249cf7dc4_submenu')) { function _lb7249cf7dc4_submenu($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb11c0e3de39_content')) { function _lb11c0e3de39_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
<?php $_b->templates['8217734513']->renderChildTemplate('../common/chronicle_picture.latte', $template->getParameters()) ?>
	</div>
</div>
<!-- end of newest photo -->
<?php } ?>
