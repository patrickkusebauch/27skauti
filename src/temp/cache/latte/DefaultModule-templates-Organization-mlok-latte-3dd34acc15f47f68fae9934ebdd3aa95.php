<?php
// source: /vagrant/src/app/FrontModule/DefaultModule/templates/Organization/mlok.latte

// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('3293515906', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block submenu
//
if (!function_exists($_b->blocks['submenu'][] = '_lbbd52a11b14_submenu')) { function _lbbd52a11b14_submenu($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb694f598542_content')) { function _lb694f598542_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
<?php $_b->templates['3293515906']->renderChildTemplate('member.latte', array('showAge' => FALSE) + $template->getParameters()) ;
}}
