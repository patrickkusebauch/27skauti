<?php
// source: /vagrant/src/app/FrontModule/DefaultModule/templates/@layout.latte

// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('9754581451', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block head
//
if (!function_exists($_b->blocks['head'][] = '_lb7eec6925bc_head')) { function _lb7eec6925bc_head($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
;
}}
...
// block submenu
//
if (!function_exists($_b->blocks['submenu'][] = '_lb470c60bbcc_submenu')) { function _lb470c60bbcc_submenu($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
;
}}
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lb8a3f150a14_scripts')) { function _lb8a3f150a14_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
;
}}
