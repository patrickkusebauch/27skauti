<?php
// source: /data/web/virtuals/88857/virtual/app/OddilModule/FrontModule/templates/Stezky/default.latte

// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('2384959561', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block head
//
if (!function_exists($_b->blocks['head'][] = '_lbb848a94694_head')) { function _lbb848a94694_head($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb2b6473cc07_content')) { function _lb2b6473cc07_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lbdda752f6a4_scripts')) { function _lbdda752f6a4_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
