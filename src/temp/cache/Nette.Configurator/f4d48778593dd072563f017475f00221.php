<?php
// source: /data/web/virtuals/88857/virtual/app/config/config.neon 
...
class SystemContainer extends Nette\DI\Container
{
	...
	protected $meta = array(
		'types' => array(
			...
			'tracy\\ibarpanel' => array('skautis.panel'),
			'skautis\\nette\\tracy\\panel' => array('skautis.panel'),
	...
	public function __construct()
	{
		parent::__construct(array(
			'appDir' => '/data/web/virtuals/88857/virtual/app',
			'wwwDir' => '/data/web/virtuals/88857/virtual/www',
			'debugMode' => TRUE,
			...
			'tempDir' => '/data/web/virtuals/88857/virtual/app/../temp',
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('/data/web/virtuals/88857/virtual/app/../temp/cache', $this->getService('nette.cacheJournal'));
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileJournal('/data/web/virtuals/88857/virtual/app/../temp');
		return $service;
	}
	...
	public function createServiceNette__latte()
	{
		...
		$service->setTempDirectory('/data/web/virtuals/88857/virtual/app/../temp/cache/latte');
	...
	{
		$service = new Nette\Application\PresenterFactory('/data/web/virtuals/88857/virtual/app', $this);
	...
	{
		$service = new Nette\Caching\Storages\PhpFileStorage('/data/web/virtuals/88857/virtual/app/../temp/cache', $this->getService('nette.cacheJournal'));
	...
	public function createServiceSkautis()
	{
		...
		$this->getService('skautis.panel')->register($service);
		return $service;
	}


	/**
	 * @return SkautIS\Nette\Tracy\Panel
	 */
	public function createServiceSkautis__panel()
	{
		$service = new SkautIS\Nette\Tracy\Panel;
		return $service;
	}
	...
	{
		$service = new Kollarovic\Thumbnail\Generator('/data/web/virtuals/88857/virtual/www', $this->getService('httpRequest'), '{dir}/thumbs/{filename}-{width}x{height}.{extension}', 'http://dummyimage.com/{width}x{height}/efefef/f00&text=Image+not+found');
		return $service;
	}
