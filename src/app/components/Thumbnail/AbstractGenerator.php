...
abstract class AbstractGenerator extends Nette\Object
{
	...
	private function createThumbPath()
	{
		...
		$search = array('{width}', '{height}', '{filename}', '{extension}', '{dir}');
		$dirname = str_replace($this->wwwDir . '/', '', $pathinfo['dirname']);
		$replace = array($this->width, $this->height, $pathinfo['filename'], $pathinfo['extension'], $dirname);
