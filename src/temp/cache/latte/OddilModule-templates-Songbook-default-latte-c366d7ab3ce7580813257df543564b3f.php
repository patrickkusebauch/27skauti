<?php
// source: /data/web/virtuals/88857/virtual/app/FrontModule/OddilModule/templates/Songbook/default.latte

// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('8730622618', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block head
//
if (!function_exists($_b->blocks['head'][] = '_lbf782d84a26_head')) { function _lbf782d84a26_head($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb6fa3df15a3_content')) { function _lb6fa3df15a3_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
