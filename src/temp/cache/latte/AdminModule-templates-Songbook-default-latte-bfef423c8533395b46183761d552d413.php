<?php
// source: /data/web/virtuals/88857/virtual/app/OddilModule/AdminModule/templates/Songbook/default.latte

// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('2475670978', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb92e0cc347c_content')) { function _lb92e0cc347c_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
