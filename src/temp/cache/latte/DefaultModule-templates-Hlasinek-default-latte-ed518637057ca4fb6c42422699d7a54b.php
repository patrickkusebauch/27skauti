<?php
// source: /data/web/virtuals/88857/virtual/app/FrontModule/DefaultModule/templates/Hlasinek/default.latte

// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('0111510849', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block head
//
if (!function_exists($_b->blocks['head'][] = '_lbba9628bee6_head')) { function _lbba9628bee6_head($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb42538930b7_content')) { function _lb42538930b7_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
<?php $_b->templates['0111510849']->renderChildTemplate('hlasinek.latte', array('dir' => $dir) + $template->getParameters()) ;
}}
