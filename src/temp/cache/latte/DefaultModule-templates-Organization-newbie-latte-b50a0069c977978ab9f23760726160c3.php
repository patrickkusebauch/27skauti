<?php
// source: /vagrant/src/app/FrontModule/DefaultModule/templates/Organization/newbie.latte

// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('1339011475', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block submenu
//
if (!function_exists($_b->blocks['submenu'][] = '_lb41ea9d3be9_submenu')) { function _lb41ea9d3be9_submenu($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb78c15793fa_content')) { function _lb78c15793fa_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
<?php $_b->templates['1339011475']->renderChildTemplate('member.latte', array('showAge' => FALSE) + $template->getParameters()) ;
}}
