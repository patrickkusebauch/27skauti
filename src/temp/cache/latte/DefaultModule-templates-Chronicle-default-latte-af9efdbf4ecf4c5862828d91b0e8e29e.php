<?php
// source: /vagrant/src/app/FrontModule/DefaultModule/templates/Chronicle/default.latte

// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('7095148621', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block head
//
if (!function_exists($_b->blocks['head'][] = '_lbe4859fb6aa_head')) { function _lbe4859fb6aa_head($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block submenu
//
if (!function_exists($_b->blocks['submenu'][] = '_lbf4b85ff6b2_submenu')) { function _lbf4b85ff6b2_submenu($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lbe99643a26d_content')) { function _lbe99643a26d_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
<?php $_b->templates['7095148621']->renderChildTemplate('../common/chronicle_picture.latte', array('chronicle' => $chronicle) + $template->getParameters()) ?>
		</div>
<?php } ?>
