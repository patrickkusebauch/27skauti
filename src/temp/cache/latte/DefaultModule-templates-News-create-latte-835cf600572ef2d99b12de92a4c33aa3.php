<?php
// source: /data/web/virtuals/88857/virtual/app/AdminModule/DefaultModule/templates/News/create.latte

// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('6418290373', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb2c60a72c8e_content')) { function _lb2c60a72c8e_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
;$_l->tmp = $_control->getComponent("editNewsForm"); if ($_l->tmp instanceof Nette\Application\UI\IRenderable) $_l->tmp->redrawControl(NULL, FALSE); $_l->tmp->render() ;
}}

//
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lb14b17c5af6_scripts')) { function _lb14b17c5af6_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
